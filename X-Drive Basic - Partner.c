...
mode = 2;
	...
	motor[port5]= vexRT[Ch2Xmtr2]; //  vexRT[Btn8DXmtr2]*-127; //Lift Right Tower
	motor[port6]= vexRT[Ch2Xmtr2]; // vexRT[Btn8DXmtr2]*-127; //Lift Left Tower
	motor[port4]= vexRT[Ch3Xmtr2]; // + vexRT[Btn7DXmtr2]*-127; //Conveyor
	}
